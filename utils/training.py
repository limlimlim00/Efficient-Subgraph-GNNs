...
def eval_loop(model, loader, eval, device, average_over=1, task='regression'):
    model.eval()
    # The vote is always 1. Code is taken from https://github.com/BarSGuy/Subgraphormer
    assert average_over == 1, f"average_over has to be 1 always"
